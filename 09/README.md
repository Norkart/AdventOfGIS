...
[5-klassejenter i Kristiansand fikser denne oppgaven](https://github.com/Norkart/GirlTechFest) - gjør ikke du også? 
...
1. Lag et webkart (MapLibre, Mapbox, OpenLayers, Leaflet) som bruker vector tiles fra en freemium-tjeneste (Maptiler, Mapbox e.l.)


Tips til software:
* https://github.com/Norkart/GirlTechFest
* https://maplibre.org/
